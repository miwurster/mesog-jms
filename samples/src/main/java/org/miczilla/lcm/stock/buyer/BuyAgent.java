package org.miczilla.lcm.stock.buyer;
...
public class BuyAgent implements CommandLineRunner
{
  @Autowired
  ...
  {
    ConsoleHelper.printHeader(BuyAgent.class.getSimpleName());
    while (true)
    {
      ...
      if (m instanceof TextMessage)
      {
        ...
        ConsoleHelper.println("> Buy this:");
  ...
  {
    SpringApplication.run(BuyAgent.class, args);
  }
  ...
  public JmsTemplate jmsTemplate(final JndiTemplate jndiTemplate) throws Exception
  {
    ...
    jmsTemplate.setDefaultDestinationName("BuyOrders");
    return jmsTemplate;
  }
}
